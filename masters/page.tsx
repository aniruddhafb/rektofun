            ...
            <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                    {pagedInfluencers.map((influencer) => (
                        <article
                            key={influencer.id}
                            className="group mx-auto flex h-full w-full max-w-[380px] flex-col overflow-hidden rounded border border-gray-400 bg-white/70 p-4 shadow-sm backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-gray-300/80 hover:shadow-xl md:max-w-[330px]"
                        >
