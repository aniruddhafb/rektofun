                ...
                <div className="relative overflow-y-auto overflow-x-hidden p-4 sm:p-6 lg:p-8">
                        ...
                        <div className="flex flex-col gap-5 lg:flex-row lg:items-start">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <div className="mt-4 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => openProfile(String(challenge.creator))}
                                    ...
                                    >
                                        <div className="h-9 w-9 shrink-0 overflow-hidden rounded-full border border-[#c8c1ba] bg-gradient-to-br from-blue-400 to-blue-600">
                                            <span className="w-full h-full flex items-center justify-center text-white text-xs font-bold">
                                                {String(challenge.creator).slice(0, 2).toUpperCase()}
                                            </span>
                                        </div>
                    ...
                    <div className="relative mb-6 overflow-visible rounded-lg border-2 border-black bg-[#1f4f3a] p-4 text-white shadow-[4px_4px_0_#111] sm:p-5">
                        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                                ...
                                <h3 className="mt-1 text-2xl font-black text-white sm:text-3xl">{challenge.ticker}</h3>
                            </div>
                    ...
                    <div className="mb-6 rounded-lg border-2 border-black bg-white p-4 shadow-[4px_4px_0_#111]">
                        ...
                        <div className="flex w-full flex-row items-center justify-center gap-2.5 max-[350px]:gap-1.5 sm:gap-4">
                            ...
                            {/* Opponent Profile - Simplified for Challenge type */}
                            <div className="relative flex flex-col items-center">
