            ...
            <div className="max-w-7xl mx-auto">
                <div className="pt-4 border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        {/* Twitter */}
                        <a href="#" className="text-gray-600 hover:text-black transition-colors cursor-pointer" aria-label="Twitter">
                        ...
                        {/* Discord */}
                        <a href="#" className="text-gray-600 hover:text-black transition-colors cursor-pointer" aria-label="Discord">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
